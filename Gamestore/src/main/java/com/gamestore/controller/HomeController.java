...
public class HomeController {
	...
	public String searchGameBySerachBar(Model m, Principal principal,
			@ModelAttribute("searchGameByName") String keyword) {
	...
	@PostMapping("/contactFormSubmit")
	public String contactFormSubmit(Model m, Principal principal, @RequestParam("userId") Long userId,
			@RequestParam("fullName") String name, @RequestParam("email") String email,
		...
		SimpleMailMessage mail = mailConstructor.contactMailSend(name, email, msg, user);
		if(mail != null) {
		...
		m.addAttribute("messageSend",true);
		m.addAttribute("user", user);
		return "contact";
	}
